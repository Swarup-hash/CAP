            ...
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active px-4" aria-current="page" href="./user/AboutCap.html">About Us</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active px-4" href="./user/whatwedo.html">What We Do</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active px-4" href="./freedomFarm/homeFarm.html" target="_blank">Freedom Farm</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active px-4"  href="./user/ambulance.html">Ambulance</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active px-4" href="./user/howcanyouhelp.html">How Can You Help</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active px-4" href="./user/updates.html">Updates</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active px-4" href="./user/Merchandise.html" target="_blank">Merchandise</a>
                            </li>
                            <li class="nav-item">
